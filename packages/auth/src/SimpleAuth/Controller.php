...
class Controller extends \CI_Controller implements AuthControllerInterface
{
     ...
     * {@inheritDoc}
     *
     * @see \CodeigniterXtend\Auth\ControllerInterface::getUserProvider()
     */
     ...
     * {@inheritDoc}
     *
     * @see \CodeigniterXtend\Auth\ControllerInterface::getMiddleware()
     */
     ...
     * {@inheritDoc}
     *
     * @see \CodeigniterXtend\Auth\ControllerInterface::login()
     */
     ...
     * {@inheritDoc}
     *
     * @see \CodeigniterXtend\Auth\ControllerInterface::logout()
     */
     ...
     * {@inheritDoc}
     *
     * @see \CodeigniterXtend\Auth\ControllerInterface::signup()
     */
     ...
     * {@inheritDoc}
     *
     * @see \CodeigniterXtend\Auth\ControllerInterface::emailVerification()
     */
     ...
     * {@inheritDoc}
     *
     * @see \CodeigniterXtend\Auth\ControllerInterface::passwordReset()
     */
    public function passwordReset()
    {
        ...
        if ($_POST) {
            $this->form_validation->set_rules(
                'email',
                self::lang('password_reset_email_field'),
                [
     ...
     * {@inheritDoc}
     *
     * @see \CodeigniterXtend\Auth\ControllerInterface::passwordResetForm()
     */
    public function passwordResetForm($token)
    {
        ...
        if ($_POST) {
            $this->form_validation->set_rules(
                'new_password',
                self::lang('password_reset_new_pwd'),
                [
            ...
            $this->form_validation->set_rules(
                'repeat_password',
                self::lang('password_reset_repeat_pwd'),
                [
                    'required'
                ]
            );
    ...
    public function confirmPassword()
    {
        ...
        if ($_POST) {
            $this->form_validation->set_rules(
                'current_password',
                self::lang('password_prompt_pwd_field'),
                [
