 ...
 */
abstract class AuthBaseMiddleware implements MiddlewareInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    final public function run($userProvider)
    {
        Debug::log(
            ...
            . get_class( is_object(ci()->getMiddleware()) ? ci()->getMiddleware() : Middleware::load(ci()->getMiddleware()) ) . ' ]',
            'info', 'auth');
